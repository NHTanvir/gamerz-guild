...
$config = [
	'per_page'		=> 5,
	'columns'		=> [
		'id'				=> __( 'Order #', 'gamerz-guild' ),
		'products'			=> __( 'Products', 'gamerz-guild' ),
		'order_total'		=> __( 'Order Total', 'gamerz-guild' ),
		'commission'		=> __( 'Commission', 'gamerz-guild' ),
		'payment_status'	=> __( 'Payment Status', 'gamerz-guild' ),
		'time'				=> __( 'Time', 'gamerz-guild' ),
	],
	...
	'bulk_actions'	=> [
		'delete'	=> __( 'Delete', 'gamerz-guild' ),
		'draft'		=> __( 'Draft', 'gamerz-guild' ),
	],
];
